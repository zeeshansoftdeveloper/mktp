...
@section('content')
        ...
        <div class="col-xl-12">
            ...
            <div class="card card-custom card-stretch gutter-b">
                ...
                <a href="{{ route('addStore') }}" class="btn btn-success btn-sm" title="Add New store">
                            ...
                            <table class="table">
                                ...
                                @foreach($stores as $item)
                                    <tr>
                                        ...
                                        <td>
                                            <a href="{{ url('showStore/' . $item->id) }}" title="View store"><button class="btn btn-info btn-sm"><i class="fa fa-eye" aria-hidden="true"></i> View</button></a>
                                            <a href="{{ url('changeStore/' . $item->id) }}" title="Edit store"><button class="btn btn-primary btn-sm"><i class="fa fa-pencil-square-o" aria-hidden="true"></i> Edit</button></a>
                                        </td>
                                    </tr>
                                @endforeach
                                </tbody>
