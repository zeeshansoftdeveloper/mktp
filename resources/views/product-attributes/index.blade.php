...
@section('content')
        ...
        <div class="col-xl-12">
            ...
            <div class="card card-custom card-stretch gutter-b">
                ...
                <a href="{{ url('addProductAttributes') }}" class="btn btn-success btn-sm" title="Add New productAttribute">
                            ...
                            <table class="table">
                                ...
                                @foreach($productattributes as $item)
                                    <tr>
                                        ...
                                        <td>
                                            <a href="{{ url('showProductAttributes/' . $item->id) }}" title="View productAttribute"><button class="btn btn-info btn-sm"><i class="fa fa-eye" aria-hidden="true"></i> View</button></a>
                                            <a href="{{ url('changeProductAttributes/' . $item->id ) }}" title="Edit productAttribute"><button class="btn btn-primary btn-sm"><i class="fa fa-pencil-square-o" aria-hidden="true"></i> Edit</button></a>

                                            <form method="POST" action="{{ url('removeProductAttributes/' . $item->id) }}" accept-charset="UTF-8" style="display:inline">
                                                {{ method_field('DELETE') }}
                                                {{ csrf_field() }}
