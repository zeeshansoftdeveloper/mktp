        ...
        <div class="col-xl-12">
            ...
            <div class="card card-custom card-stretch gutter-b">
                ...
                <a href="{{ route('vendDash') }}" title="Back"><button class="btn btn-warning btn-sm"><i class="fa fa-arrow-left" aria-hidden="true"></i> Back</button></a>
                        <a href="{{ url('changeProductAttributes/' . $productattribute->id ) }}" title="Edit productAttribute"><button class="btn btn-primary btn-sm"><i class="fa fa-pencil-square-o" aria-hidden="true"></i> Edit</button></a>

                        <form method="POST" action="{{ url('removeProductAttributes/' . $productattribute->id) }}" accept-charset="UTF-8" style="display:inline">
                            {{ method_field('DELETE') }}
                            {{ csrf_field() }}
