        ...
        <div class="col-xl-12">
            ...
            <div class="card card-custom card-stretch gutter-b">
                ...
                <div class="card-header border-0 pt-5">
                    <a href="{{ route('addProductDetails') }}" class="btn btn-success btn-sm" title="Add New Product Details">
                            ...
                            <table class="table">
                                ...
                                @foreach($productdetails as $item)
                                    <tr>
                                        ...
                                        <td>
                                            <a href="{{ url('showProductDetails/' . $item->id) }}" title="View productDetail"><button class="btn btn-info btn-sm"><i class="fa fa-eye" aria-hidden="true"></i> View</button></a>                            
                                            <a href="{{ url('changeProductDetails/' . $item->id) }}" title="Edit productDetail"><button class="btn btn-primary btn-sm"><i class="fa fa-pencil-square-o" aria-hidden="true"></i> Edit</button></a>
                                            <form method="POST" action="{{ url('removeProductDetails/' . $item->id) }}" accept-charset="UTF-8" style="display:inline">
                                                {{ method_field('DELETE') }}
                                                {{ csrf_field() }}
