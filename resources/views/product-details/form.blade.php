...
<div class="form-group {{ $errors->has('product_code') ? 'has-error' : ''}}">
    ...
    <input class="form-control" name="product_code" type="text" id="product_code" value="{{ isset($productdetail->product_code) ? $productdetail->product_code : ''}}" >
    {!! $errors->first('product_code', '<p class="help-block">:message</p>') !!}
</div>
<div class="form-group {{ $errors->has('details') ? 'has-error' : ''}}">
    <label for="details" class="control-label">{{ 'Details' }}</label>
    <input class="form-control" name="details" type="text" id="details" value="{{ isset($productdetail->details) ? $productdetail->details : ''}}" >
...
<div class="form-group {{ $errors->has('category_id') ? 'has-error' : ''}}">
    ...
    <select name="category_id" class="form-control" id="category_id" >
        ...
        @foreach ($cats as $cat)
            <option value="{{ $cat->id }}" {{ (isset($productdetail->category_id) && $productdetail->category_id === $cat->id) ? 'selected' : ''}}>{{ $cat->cat_name }}</option>
        @endforeach
</select>
...
<div class="form-group {{ $errors->has('stock_unit') ? 'has-error' : ''}}">
    ...
    <input class="form-control" name="stock_unit" type="number" id="stock_unit" value="{{ isset($productdetail->stock_unit) ? $productdetail->stock_unit : ''}}" >
    {!! $errors->first('stock_unit', '<p class="help-block">:message</p>') !!}
</div>
<div class="form-group {{ $errors->has('price') ? 'has-error' : ''}}">
    <label for="price" class="control-label">{{ 'Price' }}</label>
    <input class="form-control" name="price" type="number" id="price" value="{{ isset($productdetail->price) ? $productdetail->price : ''}}" >
    {!! $errors->first('price', '<p class="help-block">:message</p>') !!}
</div>
<div class="form-group {{ $errors->has('discount') ? 'has-error' : ''}}">
    <label for="discount" class="control-label">{{ 'Discount' }}</label>
    <input class="form-control" name="discount" type="number" id="discount" value="{{ isset($productdetail->discount) ? $productdetail->discount : ''}}" >
...
<div class="form-group {{ $errors->has('discount_start') ? 'has-error' : ''}}">
    ...
    <input class="form-control" name="discount_start" type="date" id="discount_start" value="{{ isset($productdetail->discount_start) ? $productdetail->discount_start : ''}}" >
...
<div class="form-group {{ $errors->has('discount_end') ? 'has-error' : ''}}">
    ...
    <input class="form-control" name="discount_end" type="date" id="discount_end" value="{{ isset($productdetail->discount_end) ? $productdetail->discount_end : ''}}" >
...
<div class="form-group {{ $errors->has('price_type_id') ? 'has-error' : ''}}">
    ...
    @foreach ($pricingTypes as $pricetype)
        <option value="{{ $pricetype->id }}" {{ (isset($productdetail->price_type_id) && $productdetail->price_type_id === $pricetype->id) ? 'selected' : ''}}>{{ $pricetype->type_name }}</option>
    @endforeach
</select>
