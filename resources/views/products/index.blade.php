        ...
        <div class="col-xl-12">
            ...
            <div class="card card-custom card-stretch gutter-b">
                ...
                <div class="card-header border-0 pt-5">
                    <a href="{{ route('addproduct') }}" class="btn btn-success btn-sm" title="Add New Product">
                            ...
                            <table class="table">
                                ...
                                @foreach($products as $item)
                                    <tr>
                                        ...
                                        <td>
                                            <a href="{{ url('showProduct/' . $item->id) }}" title="View product"><button class="btn btn-info btn-sm"><i class="fa fa-eye" aria-hidden="true"></i> View</button></a>
                                            <a href="{{ url('changeProduct/' . $item->id ) }}" title="Edit product"><button class="btn btn-primary btn-sm"><i class="fa fa-pencil-square-o" aria-hidden="true"></i> Edit</button></a>
											<!-- <form method="POST" action="{{ url('removeProduct/' . $item->id) }}" accept-charset="UTF-8" style="display:inline">
                                                {{ method_field('DELETE') }}
                                                {{ csrf_field() }}
