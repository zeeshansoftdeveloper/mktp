        ...
        <div class="col-xl-12">
            ...
            <div class="card card-custom card-stretch gutter-b">
                ...
                <div class="card-body pt-2 pb-0">
                    ...
                    <div class="card">
                    <div class="card-header"> <span class="card-label font-weight-bolder text-dark">Edit product #{{ $product->id }}</span></div>
                    <div class="card-body">
                        ...
                        <form method="POST" action="{{ route('updateProduct') }}" accept-charset="UTF-8" class="form-horizontal" enctype="multipart/form-data">
                            {{ method_field('POST') }}
                            {{ csrf_field() }}
