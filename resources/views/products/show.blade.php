        ...
        <div class="col-xl-12">
            ...
            <div class="card card-custom card-stretch gutter-b">
                ...
                <a href="{{ url('vendDash') }}" title="Back"><button class="btn btn-warning btn-sm"><i class="fa fa-arrow-left" aria-hidden="true"></i> Back</button></a>
                        <a href="{{ url('changeProduct/' . $product->id) }}" title="Edit product"><button class="btn btn-primary btn-sm"><i class="fa fa-pencil-square-o" aria-hidden="true"></i> Edit</button></a>                     
                </div>
                <div class="card">
                        ...
                        <div class="table-responsive">
                            <table class="table">
                                <tbody>
                                    ...
                                    <tr><th> Name </th><td> {{ $product->name }} </td></tr><tr><th> Store Id </th><td> {{ $product->store_id }} </td></tr>
                                </tbody>
                            </table>
                        </div>
