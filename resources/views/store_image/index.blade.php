        ...
        <div class="col-xl-12">
            ...
            <div class="card card-custom card-stretch gutter-b">
                ...
                <div class="card-header border-0 pt-5">
                    <a href="{{ route('addstoreImg') }}" class="btn btn-success btn-sm" title="Add New Product">
                                ...
                                @foreach($store_image as $item)
                                    <tr>
                                        ...
                                        <td>
                                            ...
                                            <a href="{{ url('changestoreImg/' . $item->id ) }}" title="Edit store_image"><button class="btn btn-primary btn-sm"><i class="fa fa-pencil-square-o" aria-hidden="true"></i> Edit</button></a>
                                        </td>
                                    </tr>
                                @endforeach
                                </tbody>
