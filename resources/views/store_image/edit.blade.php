...
@section('content')
        ...
        <div class="col-xl-12">
            ...
            <div class="card card-custom card-stretch gutter-b">
                ...
                <div class="card">
                    <div class="card-header">Edit store_image #{{ $store_image->id }}</div>
                    <div class="card-body">
                        ...
                        <form method="POST" action="{{ route('updatestoreImg') }}" accept-charset="UTF-8" class="form-horizontal" enctype="multipart/form-data">
                            {{ method_field('POST') }}
                            {{ csrf_field() }}

                            @include ('store_image.form', ['formMode' => 'edit'])
