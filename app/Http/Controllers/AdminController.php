...
class AdminController extends Controller
{
    ...
    {
        $pmenus = Menu::with('menus')->whereNull('parent_id')->where('user_id', '=', Auth::user()->id)->get();
        $cmenus = Menu::with('menu')->whereNotNull('parent_id')->where('user_id', '=', Auth::user()->id)->get();
       return view('dashboard.index', compact('pmenus', 'cmenus'));
    }
    ...
    {
        $data = Menu::where('id', '=', $request->value)->orWhere('parent_id', '=', $request->value)->value('menu_link');
    ...
    public function storeMenu(Request $request)
    {
        ...
        Menu::updateOrCreate($matchThese,
                [
                    'name'=>$request->name,
